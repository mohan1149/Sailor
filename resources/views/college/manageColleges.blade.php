...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sailor | Manage Colleges</title>
        <!-- Styles -->
        <style>
            .menu{
                display:none;
            ...
            <div class="school-tables">
                <table class="w3-padding  w3-bordered w3-table">
                    <tr class="w3-white">
                        ...
                        <th class="w3-text-grey"><i class='fa fa-tag w3-text-purple w3-xlarge'></i><span class="w3-small"> College ID</span></th>
                    </tr>
                    <?php
                        foreach($colleges as $college)
                            ...
                            ?>
                                <tr>
                                    <td class="w3-large"><?php echo $college->clg_reg_num ?></td>
                                    <td class="w3-large"><?php echo $college->clg_name ?></td>
                                    <td class="w3-large"><?php echo $college->clg_phone ?></td>
                                    <td class="w3-large"><a href="mailto:<?php echo $college->clg_email ?>"><?php echo $college->clg_email ?></a></td>
                                    <td class="w3-large"><a target="_blank"href="<?php echo $college->clg_website ?>"><?php echo $college->clg_website ?></a></td>
                                    <td class="w3-large"><?php echo $college->id ?></td>
                                    <!-- <td><?php //echo $school->school_address ?></td> -->
                                    <!-- <td><img width="38px" class='school_logo'src="<?php //echo $school->logo_path ?>"></td> -->
                                    <td>
                                        <a target="_blank" title="View"class="w3-text-indigo" href="/view/college/<?php echo base64_encode($college->id) ?>"> <i class="fa fa-eye w3-xlarge"></i></a>
                                    </td>
                                    <td>
                                        <a target="_blank" title="Edit"class="w3-text-blue" href="/edit/college/<?php echo base64_encode($college->id) ?>"> <i class="fa fa-edit w3-xlarge"></i></a>
                                    </td>
                                    <td>
                                        <a title="Delete" class="w3-text-red delete-button" href="javascript:void(0)" url="/delete/college/<?php echo $college->id ?>"> <i class="fa fa-trash w3-xlarge"></i></a>
                                    </td>
                                </tr>
                            <?php
                        }
