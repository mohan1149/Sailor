    ...
    <div class="w3-main"  style="margin-left:310px;margin-top:43px;margin-right:10px;">
        <header class="w3-container w3-margin" style="padding-top:22px">
            <ul class="breadcrumb">
              ...
              <li><a href="/manage/staff">Manage School Teaching Staff</a></li>              
            </ul>
        </header>
                          ...
                          foreach($response_data as $employee){                              
                              ?>
                                  <div class="w3-container w3-margin w3-accordion">
                                      <button class="w3-indigo  w3-button w3-block w3-left-align staff-show" id ="staff-<?php echo $employee['school_id']?>">
                                          <?php echo $employee['school_name']; ?>
                                          <i class="fa fa-plus w3-right"></i>
                                      </button>
                                      <div class="inactive w3-table w3-bordered w3-margin w3-accordion-content content-table staff-<?php echo $employee['school_id']?>">
                                        <?php
                                            if(count($employee['school_depts']) !=0){ 
                                                foreach ($employee['school_depts'] as $dept) {                                                    
                                                ?>
                                                    ...
                                                    <div class="inactive-inner w3-table w3-bordered w3-margin w3-accordion-content content-table-inner dept-<?php echo $dept['dept_id']?>">
                                                      <div class="search-container">
                                                        <input type="text" class="search" placeholder="Search staff..."> <i class="fa fa-search"></i>
                                                      </div>
                                                                      ...
                                                                      foreach($dept['staff_data'] as $key => $staff){
                                                                          ?>
                                                                              <tr>
                                                                                  ...
                                                                                  <td><?php echo $staff->teacher_designation?></td>
                                                                                  <td><?php echo $staff->teacher_join_date?></td>
                                                                                  <td><a href='/edit/staff/<?php echo base64_encode($staff->id)?>' class='w3-xlarge w3-text-blue' title='Edit'><i class="fa fa-edit"></i></a></td>
                                                                                  <td><a href='/view/staff/<?php echo base64_encode($staff->id)?>' class='w3-xlarge w3-text-purple' title='View'><i class="fa fa-eye"></i></a></td>
                                                                                  <td><a href='javascript:void(0)' url = "/delete/staff/<?php echo $staff->id ?>" class='w3-xlarge w3-text-red delete-button' title='Delete'><i class="fa fa-trash"></i></a></td>
                                                                              </tr>
                                                                          <?php
                                                                        }
                                                                        ?>
                                                                            <tr>
                                                                                <strong>Total Department Strength: </strong><?php echo count($dept['staff_data']); ?>
                                                                            </tr>
                                                                        <?php
                                                                    }else{
                                                                      ?>
