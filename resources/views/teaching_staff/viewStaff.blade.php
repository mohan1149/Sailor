    ...
    <div class="w3-main"  style="margin-left:310px;margin-top:43px;margin-right:10px;">
        <header class="w3-container" style="padding-top:22px">
          <ul class="breadcrumb">
            ...
            <li><?php echo $staff_data['staff']->teacher_name?></li>
          </ul>
        </header>
                ...
                <div class="w3-row">
                    <div class="w3-third s_info">
                        <div class="w3-display-container school-logo">
                            <img class="w3-margin logo "src="<?php echo $staff_data['staff']->teacher_profile ?>" width="100%">
                        </div>
                        <div class="w3-container w3-text-black">
                            <h2><?php echo $staff_data['staff']->teacher_name?></h2>
                        </div>
                        <div class="w3-container">
                            <p><i class="fa fa-black-tie fa-fw w3-margin-right w3-large w3-text-red w3-xlarge"></i><?php echo $staff_data['staff']->teacher_reg_id ?></p>
                            <p><i class="fa fa-graduation-cap fa-fw w3-margin-right w3-large w3-text-red w3-xlarge"></i><?php echo $staff_data['staff']->teacher_designation ?></p>
                            <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-red w3-xlarge"></i><?php echo $staff_data['staff']->teacher_email ?></p>
                            <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-red w3-xlarge"></i><?php echo $staff_data['staff']->teacher_phone ?></p>
                        </div>
                    </div>
