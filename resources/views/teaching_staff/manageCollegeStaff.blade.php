                          ...
                          foreach($response_data as $employee){                              
                              ?>
                                  <div class="w3-container w3-margin w3-accordion">
                                      <button class="w3-indigo  w3-button w3-block w3-left-align staff-show" id ="staff-<?php echo $employee['clg_id']?>">
                                          <?php echo $employee['clg_name']; ?>
                                          <i class="fa fa-plus w3-right"></i>
                                      </button>
                                      <div class="inactive w3-table w3-bordered w3-margin w3-accordion-content content-table staff-<?php echo $employee['clg_id']?>">
                                        <?php
                                            if(count($employee['clg_depts']) !=0){ 
                                                foreach ($employee['clg_depts'] as $dept) {                                                    
                                                ?>
