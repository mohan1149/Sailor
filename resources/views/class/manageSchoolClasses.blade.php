                                                                    ...
                                                                    foreach($dept['class_data']['classes'] as $key => $class){
                                                                        ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo $class->class_num_subjects?></td>
                                                                                ...
                                                                                <td><a href='/view/timetable/<?php echo base64_encode($class->id)?>?cl=<?php echo base64_encode($class->class_name); ?>' class='w3-xlarge w3-text-indigo' title='Timetable'><i class="fa fa-clock-o"></i></a></td>
