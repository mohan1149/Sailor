...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="w3-container login-container">
            <div class="logo-container w3-center">
                <svg class="site-logo" width="200" viewBox="0 0 268.2120056152344 267.4739990234375">
                    <g>
                ...
                @csrf
                    ...
                    <!-- <span><i class='fa fa-envelope login-icons'></i></span> -->
                        <input class="form-input email"type='email' placeholder="<?php echo $$strings['email'];?>" name='email'>
                    </div>
                    <div class='form-password'>
                        <!-- <span><i style="font-size:21px;"class='fa fa-lock login-icons'></i></span> -->
                        <input class="form-input password" type='password' placeholder=<?php echo $$strings['password']?> name='password'>
                    </div>
                    <div class='form-group w3-margin-top' style='text-align:center'>
                        <input class="submit form-input w3-button w3-light-grey" type='submit' value="<?php echo $$strings['login']?>">
                    </div>
                </form> 
                <a class="w3-margin-top w3-text-white w3-button" href="/forgot/password"><?php echo $$strings['forgotpwd']?></a>
            </div>
        </div>              
    </body>
</html>
