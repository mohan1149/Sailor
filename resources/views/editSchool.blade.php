...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Edit School or College</title>
    ...
    <body>
        <div class="w3-row">
            <div class="w3-half left ">    
                <div class="left-container w3-center">
                    <svg width="200" viewBox="0 0 268.2120056152344 267.4739990234375" style="margin-top:20vh">
                        <g>
                ...
                <div class="right-container">
                    <div class="content">
                        <div class='signup-form'>
                            ...
                            <form action='/api/update/school/<?php echo $schools[0]->id ?>' method="POST" class="w3-center" enctype="multipart/form-data">
                                <?php 
                                    foreach($schools as $school){
                                        ?>
                                            ...
                                            <div class='form-group'>
                                                <input class="form-submit w3-button" type='submit' value="<?php echo "Save";//echo $$strings['add']?>">
                                            </div>
                                        <?php
                                    }
                                ?>
