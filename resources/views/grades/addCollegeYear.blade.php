...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="w3-main"  style="margin-left:310px;margin-top:43px;margin-right:10px;">
        ...
        <ul class="breadcrumb">
              ...
              <li><a href="">Add Year To College</a></li>
            </ul>
        </header>
            ...
            <div class="add-institute">                
                <form action='/add/year' method="POST" class="w3-center w3-margin-top" enctype="multipart/form-data">
                    ...
                    <div class='form-group'>
                        ...
                        <input required type='text' class="form-input"autofocus name='year_value' placeholder='Eg: II Year' >
                    </div>
                    <div class='form-group'>
                        ...
                        <select required class="form-input" name='ins_id'>
                            <?php
                                foreach($colleges as $college){
                                    ?>
                                        <option value=<?php echo $college->id;?>><?php echo $college->clg_name ?></option>
                                    <?php
                                }
                            ?>
                        </select>
