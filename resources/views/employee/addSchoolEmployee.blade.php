...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="w3-main"  style="margin-left:310px;margin-top:43px;margin-right:10px;">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="">Add Employee to SChool</a></li>
          </ul>
        </header>
                ...
                <form action='/store/employee' method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class='form-group'>
                            ...
                            <input required class="form-input" type='text' name='staff_id' placeholder='ID' >
                        </div>
                        <div class='form-group'>
                            <span><i class='fa fa-user w3-xlarge w3-text-blue'></i></span>
                            <input required class="form-input" type='text' name='staffname' placeholder='employee name' >
                        </div>
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                            ...
                            <input required class="form-input" type='text' placeholder='designation' name='designation'>
                        </div>
                        <div class='form-group'> 
                            <p>Date Of Joining</p>                           
                        ...
                        <div class='form-group' style='text-align:center'>
                            <input class=" w3-disabled w3-button form-input form-submit" type='submit' value="Add">
                        </div>
                    </form>
            </div>
        </div>
