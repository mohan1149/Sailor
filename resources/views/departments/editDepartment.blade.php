...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sailor | Edit Department</title>
        <!-- Styles -->
        <style>
            html, body {
                /* color: #636b6f; */
            ...
            <div class="add-institute">
                <form action='/update/department/<?php echo base64_encode($dep_data->id)?>' method="POST" class="w3-center" enctype="multipart/form-data">
                    ...
                    <div class='form-group'>
                        ...
                        <input value="<?php echo $dep_data->dept_name ?>"required type='text' class="form-input"autofocus name='dept-name' placeholder='Eg: Science Department' >
                    </div>
                    <div class='form-group'>
                        <span><i class='fa fa-envelope w3-text-blue w3-xlarge'></i></span>
                        <input value="<?php echo $dep_data->dept_email?>" placeholder="<?php echo $$strings['email']?>" type='email' name='email' class="form-input" >
                    </div>
                    <div class='form-group'>
