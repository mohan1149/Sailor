                ...
                <div class="departments">                    
                    <?php
                        if(count($return_data) != 0){                            
                            foreach($return_data['schools'] as $school){                                                  
                                ?>
                                    <div class="w3-container w3-margin w3-accordion">
                                        <button class="w3-indigo w3-button w3-block w3-left-align staff-show" id ="school-<?php echo $school['school_id']; ?>">
                                            <?php echo $school['school_name']; ?>
                                            <i class="fa fa-plus w3-right"></i>
                                        </button>
                                        <div class="inactive w3-margin w3-accordion-content content-table school-<?php echo $school['school_id'] ?>">
                                            <div class="search-container">
                                                <input type="text" class="search" placeholder="Search here..."> <i class="fa fa-search"></i>
                                            </div>
                                            <table width='100%' style='text-align:center' class="searchable w3-table w3-bordered">
                                            <tr class="w3-white">
                                            ...
                                            <?php
                                                if(count($school['school_depts']) ==0 ){
                                                    ?>
                                                        <tr>
                                                            <td>
                                                                <i class="fa fa-exclamation-triangle w3-xlarge"></i>  No Department has added.
                                                            </td>
                                                        </tr>
                                                    <?php
                                                }else{
                                                    foreach($school['school_depts'] as $dep_data){                                                    
                                                        ?>
                                                            <tr>
                            ...
                            ?>
                                <div class=" w3-red w3-container w3-margin">
                                    <p class="w3-xlarge"><i class="fa fa-exclamation-triangle w3-xlarge"></i>  No Department has added. <a href="/add/department">Click here to add.</a></p>
                                </div>
                            <?php
                        }
                    ?>
